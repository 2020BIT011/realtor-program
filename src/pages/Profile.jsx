  ...
  return (
    ...
    <div className="flex-justify-between whitespace-nowrap txt-sm:text-lg">
      ...
      className="text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out cursor-pointer">Sign Out</p>
        ...
        <button type="submit" className="w-full bg-blue-600 text-white uppercase px-7 py-7 text-sm font-medium rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800">
